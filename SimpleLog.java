...
public class SimpleLog{
	...
	{
		return this.getId() + delimiter + this.getDateTime() + delimiter + this.getErrorMessage() +
				delimiter + this.getLevel() + delimiter + this.getClassName() + delimiter + this.getMethodName();
	}
}